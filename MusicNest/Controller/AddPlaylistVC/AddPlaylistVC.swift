    ...
    func showPlaylistInput(for music: MusicModel) {
        let alert = UIAlertController(title: "New Playlist", message: "Enter playlist name", preferredStyle: .alert)
            ...
            alert.addAction(UIAlertAction(title: "Create", style: .default) { [weak self] _ in
                ...
                let platlistMusicData = PlaylistMusicModel(id: music.id, title: music.title, imageData: music.imageData, artist: music.artist, date: music.date, isFavourite: music.isFavourite, fileName: music.fileName, isExtractedAudio: music.isExtractedAudio)
